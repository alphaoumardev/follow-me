...
//                 image:imageUrl
//             }
//             client.createIfNotExists(doc).then(r => navigate('/',{replace:true}))
//     }
//     return(
...
//                             render={(renderProps) =>
//                             (
//                                 <button type='button' className="bg-mainColor flex justify-center items-center rounded-lg cursor-pointer outline-none"
